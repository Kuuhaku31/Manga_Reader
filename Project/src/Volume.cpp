...
bool
Volume::Load(std::wstring p, bool reading_directions)
{
    namespace fs = std::filesystem;

    std::cout << "Volume loading: ";
    std::wcout << p;
    std::cout << std::endl;
    ...
    if(!fs::exists(p))
    {
        std::cout << "Volume path not exists: ";
        std::wcout << p;
        std::cout << std::endl;
        return false;
    }
    ...
    {
        std::cout << "Volume pages empty: ";
        std::wcout << volume_path;
        std::cout << std::endl;
        return false;
    }
    else
